...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createBookItem(book) {
        ...
        removeButton.style.padding = '17px';
        removeButton.style.margin = '17px';
        ...
        toggleButton.style.padding = '17px';
        toggleButton.style.borderRadius = '14px';
        toggleButton.style.border = '0';
        toggleButton.style.backgroundColor = '#3af043';
